...
namespace MyElectricShop.Areas.Admin.Controllers
{
    ...
    public class SpecialOfferController : Controller
    {
        ...
        public SpecialOfferController(IProductRepository productRepository, ICategoryRepository categoryRepository, IUserRepository userRepository, IOrderRepository orderRepository)
        {
        ...
        public IActionResult Index()
        {
            ...
            var myElectricShopContext = _productRepository.GetAllSpecialProducts();
        ...
        public IActionResult Create([Bind("ProductId,CategoryId,Name,Description,Price,IsExist,Favorite,ShowInSlider,IsSpecial,OldPrice")] ProductViewModelTest productvm)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(int id, [Bind("id,CategoryId,Name,Description,Price,IsExist,IsSpecial,ShowInSlider,OldPrice")] ProductViewModelTest productvm)
        {
            if (id != productvm.id)
            {
                return NotFound();
